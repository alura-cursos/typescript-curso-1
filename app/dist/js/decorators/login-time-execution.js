export function loginTimeExecution(inSeconds = false) {
    return function (target, propertyKey, descriptor) {
        ...
        descriptor.value = function (...args) {
            ...
            console.log(`${propertyKey}, tempo de execução: ${(timeExecutionMethodInitial - timeExecutionMethodFinal) / division} ${units}`);
            return returnMethod;
        };
        return descriptor;
    };
}
//# sourceMappingURL=login-time-execution.js.map